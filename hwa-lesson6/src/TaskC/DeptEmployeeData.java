...
public class DeptEmployeeData {
	...
	public static void mySortFunction (DeptEmployee[] deptEmployee) {
		class myLocalDept implements Comparator<DeptEmployee> {
			@Override
			public int compare(DeptEmployee o1, DeptEmployee o2) {
				return Double.compare(o2.getSalary(), o1.getSalary()); //Sort Descending
			}
		}
		myLocalDept myLocal = new myLocalDept();
		Arrays.sort(deptEmployee,myLocal);
//		System.out.println("Sort by Salary: " + Arrays.toString(deptEmployee));
	}
}
